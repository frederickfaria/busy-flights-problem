...
public class BusyFlightsServiceImpl implements IBusyFlightsService {
    ...
    List<BusyFlightsAdapterInterface> adapters = new ArrayList<>();
    ...
    public List<BusyFlightsResponse> searchFlights(BusyFlightsRequest busyFlightsRequest) {
        ...
        for (BusyFlightsAdapterInterface commonsAdapter : this.adapters) {
    ...
    @Override
    public void addAdapter(BusyFlightsAdapterInterface adapter){
